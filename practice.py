...
def halvesies(numbers):
    ...
    for x in numbers:
        results = float(x)/2
        new_numbers_list.append(results)
...
def average(numbers):
    ...
    average = float(sum_numbers(numbers))/ len(numbers)
...
#         return words[0]
#     for x in words:
#         new_string_list = new_string_list + x + ","
